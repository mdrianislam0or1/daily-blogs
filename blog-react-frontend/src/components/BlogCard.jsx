...
const BlogCard = ({blog, blogs, setBlogs}) => {
  ...
  return (
    <div className='flex flex-col justify-between sm:flex-row sm:justify-start sm:items-center mb-4'>
        ...
        <div className='max-w-xs sm:max-w-md'>
            ...
            <div className='flex flex-row justify-between items-center'>
                <a href={`/blog/${blog.id}`} className='bg-black px-2 py-2 text-white'>Details</a>
                <div className='flex items-center'>
                    <a href='#' className='text-danger mr-2' onClick={() => deleteBlog(blog.id)}>
